...
if($error=="")
{
      ...
      //  $mail->Port = 587;                                    // TCP port to connect to
        ...
        $mail->From = 'wizteqengineers@gmail.com';
        $mail->FromName ='wizteqengineers@gmail.com'; 
		$mail->addAddress('wizteqengineers@gmail.com'); 
       
        $mail->AddAttachment( $_FILES['file']['tmp_name'], $_FILES['file']['name'] );
        $mail->Subject  = 'Wizteq Engineers Pvt. Ltd.';
        $mail->isHTML(true);
